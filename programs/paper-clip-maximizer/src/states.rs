...
impl PaperclipGroup {
    pub fn init(&mut self, admin: Pubkey,) -> (u8, u8, u8, u8) {
        ...
        (group_bump, authority_bump, source_bump, burn_bump)
    }
}
